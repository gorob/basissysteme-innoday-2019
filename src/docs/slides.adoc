...
[.big]
* *Cockpit* +
https://cockpit.badenia.de/

{nbsp}

[.big]
* *Interner Link im Browser* +
http://vip-axway-prod:8086/RealtimeUeberwachungMonitor
